...
class DetachedHome : AppCompatActivity() {
    ...
    val houseList = listOf(
        HouseItem(R.drawable.dh1, "123 Main St ", "  $1M"),
        HouseItem(R.drawable.dh2, "456 Elm St ", "  $2M"),
        HouseItem(R.drawable.dh3, "789 Oak Ave ", "  $1.5M"),
        HouseItem(R.drawable.dh4, "101 Pine Dr ", "  $3M"),
        HouseItem(R.drawable.dh5, "222 Maple Ln ", "  $2.5M")
    )
