...
class Condominium : AppCompatActivity() {

    val houseList = listOf(
        HouseItem(R.drawable.c1, "123 Main St ", "  $1M"),
        HouseItem(R.drawable.c2, "456 Elm St ", "  $2M"),
        HouseItem(R.drawable.c3, "789 Oak Ave ", "  $1.5M"),
        HouseItem(R.drawable.c4, "101 Pine Dr ", "  $3M"),
        HouseItem(R.drawable.c5, "222 Maple Ln ", "  $2.5M")
    )
