...
class SemiDetachedHome : AppCompatActivity() {
    val houseList = listOf(
        HouseItem(R.drawable.sd1, "123 Main St ", "  $1M"),
        HouseItem(R.drawable.sd2, "456 Elm St ", "  $2M"),
        HouseItem(R.drawable.sd3, "789 Oak Ave ", "  $1.5M"),
        HouseItem(R.drawable.sd4, "101 Pine Dr ", "  $3M"),
        HouseItem(R.drawable.sd5, "222 Maple Ln ", "  $2.5M")
    )
