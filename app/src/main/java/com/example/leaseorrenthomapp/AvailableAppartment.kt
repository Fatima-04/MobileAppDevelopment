...
class AvailableAppartment : AppCompatActivity() {

    val houseList = listOf(
        HouseItem(R.drawable.a1, "123 Main St ", "  $1M"),
        HouseItem(R.drawable.a2, "456 Elm St ", "  $2M"),
        HouseItem(R.drawable.a3, "789 Oak Ave ", "  $1.5M"),
        HouseItem(R.drawable.a4, "101 Pine Dr ", "  $3M"),
        HouseItem(R.drawable.a5, "222 Maple Ln ", "  $2.5M")
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_available_appartments)
